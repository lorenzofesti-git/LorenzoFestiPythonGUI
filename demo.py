...
def streamlines():
    ...
    yVals    = [-1, 1]                                                      # Y-grid extents [min, max]
...
def plot1(): 
    ...
    plot1.plot(xu,yu,'k-',xl,yl,'k-',x,ymediana,'r-')
    plot1.plot([panel.xc for panel in panels if panel.loc == 'upper'],
            [panel.cp for panel in panels if panel.loc == 'upper'],
            color='r', linestyle='-', linewidth=2, marker='o', markersize=6)
    
    plot1.plot([panel.xc for panel in panels if panel.loc == 'lower'],
